...
public class ArticleActivity extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		absEdit = (EditText) findViewById(R.id.edit_article_abs);
		...
		Log.i(LOG_TAG, "Article Activity Created");
	}
	...
	public void onClick(View v) {
		...
		if(v.equals(addButton)){
			...
			String abs = absEdit.getText().toString();
