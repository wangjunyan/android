...
public class MainActivity extends ListActivity implements AdapterView.OnItemClickListener {
    ...
    private static final String[] ITEMS = {"Touch Events Handle", "Scroll Test", "Temp Test", "First Line Code",
            "Photo Selector", "Crazy Android", "Like Button", "Radar Scan", "Float View", "Temp Test2", "Drag and Drop",
    "ImageView Test", "WebView Test"};
