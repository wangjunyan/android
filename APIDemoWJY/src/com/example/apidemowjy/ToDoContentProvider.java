...
public class ToDoContentProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://com.example.apidemowjy.todoprovider/todoitems");
	...
	static {
		...
		uriMatcher.addURI("com.example.apidemowjy", "todoitems", ALLROWS);
		uriMatcher.addURI("com.example.apidemowjy", "todoitems/#", SINGLE_ROW);
	}
	...
	public String getType(Uri uri) {
		...
		switch (uriMatcher.match(uri)) {
		case ALLROWS:
			return "vnd.android.cursor.dir/vnd.example.apidemowjy.todos";
		case SINGLE_ROW:
			return "vnd.android.cursor.item/vnd.example.apidemowjy.todos";
		default:
