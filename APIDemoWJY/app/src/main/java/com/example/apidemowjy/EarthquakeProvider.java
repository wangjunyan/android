...
public class EarthquakeProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://com.example.apidemowjy.earthquakeprovider/earthquakes");
	...
	static {
		...
		uriMatcher.addURI("com.example.apidemowjy.earthquakeprovider",
				"earthquakes", QUAKES);
		uriMatcher.addURI("com.example.apidemowjy.earthquakeprovider",
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case QUAKE_ID:
			Log.d(MyApplication.TAG, "uri = " + uri);
			Log.d(MyApplication.TAG, "where = " + KEY_ID + "=" + uri.getPathSegments().get(1));
			qb.appendWhere(KEY_ID + "=" + uri.getPathSegments().get(1));
			break;
		case SEARCH:
			// summary LIKE "% %"
			Log.d(MyApplication.TAG, "uri = " + uri);
			Log.d(MyApplication.TAG, "where = " + KEY_SUMMARY + " LIKE \"%" + uri.getPathSegments().get(1) + "%\"");
	...
	public String getType(Uri uri) {
		...
		switch (uriMatcher.match(uri)) {
		case QUAKES:
			return "vnd.android.cursor.dir/vnd.example.apidemowjy.earthquake";
		case QUAKE_ID:
			return "vnd.android.cursor.item/vnd.example.apidemowjy.earthquake";
		case SEARCH:
